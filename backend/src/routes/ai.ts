...
import { getAnthropicClient, BRAND_SYSTEM_PROMPT, MARKETING_SYSTEM_PROMPT, INSIGHTS_SYSTEM_PROMPT } from "../lib/anthropic";
...
aiRouter.post("/chat", async (req, res) => {
  ...
  try {
    const response = await anthropic.messages.create({
      model: MODEL,
      max_tokens: 300,
      system: persona === "marketing" ? MARKETING_SYSTEM_PROMPT : BRAND_SYSTEM_PROMPT,
